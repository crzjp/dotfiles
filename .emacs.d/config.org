...
This is for the built-in and default completion UI, in the case of not using vertico/fido (very rarely).
...
Disabled fido config (also built-in) to a (probably) future more polished version.

#+begin_src emacs-lisp :tangle no
;; place this on completion style section
...
*** Don't allow the cursor to move inside the prompt
...
Render ASCII color escape codes, taken from [[https://stackoverflow.com/a/3072831/13215205][here]].
